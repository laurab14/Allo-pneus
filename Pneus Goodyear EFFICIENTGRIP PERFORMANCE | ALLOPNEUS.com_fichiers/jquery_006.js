...
;(function($){
	...
	function showBox(curSettings, $elt){
		...
		// Show $superbox
		$superbox.css({position: "static", top: "0px", opacity: 0});
	...
	function createElements(){
		if (!$.superbox.elementsReady){
			...
			$closeBtn = $('<p class="close" title="'+ settings.closeTxt +'"><a><strong><span></span></strong></a></p>').prependTo($superbox).find("a");
			...
			$superbox.click(function(e){
				if(!$(e.target).hasClass('byPassSuperBox')) {
                    e.stopPropagation()
                }
			});
